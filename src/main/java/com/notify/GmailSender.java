...
public class GmailSender {
	...
	public static Credential authorize() throws IOException {
		InputStream in = new FileInputStream(System.getProperty("user.home") + "/Shoptasticles-28426d3d22aa.json");
	...
	public static Gmail getGmailService() throws IOException {
		...
		return new Gmail.Builder(HTTP_TRANSPORT, JSON_FACTORY, credential).setApplicationName("SendShoptasticlesEmails").build();
	}
  ...
  public static void sendMessage(Gmail service, String userId, MimeMessage email)
    ...
    System.out.println(send.buildHttpRequestUrl());
    HttpRequest request = send.buildHttpRequest();
    System.out.println(request);
    //System.exit(1);
    HttpResponse response = send.executeUnparsed();
    try {
